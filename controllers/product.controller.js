...
module.exports.getProducts = async (req, res) => {
  //Lấy dữ liệu từ file Products.txt (Bài tập 1)
  var products = [];
  ...
  var newProducts = products.map((product) => ({
    ...
    ID: product.ID,
    name: product.name,
    price: product.price.toLocaleString("vi", {
      style: "currency",
      currency: "VND",
    }),
    brand: product.brand,
...
module.exports.getProducts2 = async (req, res) => {
  //Lấy dữ liệu từ MongoDB (Bài tập 3)
      ...
      if (product.brand === req.body.brand) {
        ...
        if (product.amount === parseInt(req.body.amount)) {
          ...
          if (product.description === req.body.description) {
            ...
            product.save();
            message.push(
              "You changed brand, amount and description successfully"
            );
            res.render("product/detail", {
              product: product,
              message: message,
      ...
      if (product.brand === req.body.brand) {
        if (product.amount === parseInt(req.body.amount)) {
          ...
          if (product.description === req.body.description) {
            ...
            product.save();
            message.push(
              "You changed price, amount and description successfully"
            );
            res.render("product/detail", {
              product: product,
              message: message,
        ...
        if (product.amount === parseInt(req.body.amount)) {
          if (product.description === req.body.description) {
            ...
            product.save();
            message.push(
              "You changed price, brand and description successfully"
            );
            res.render("product/detail", {
              product: product,
              message: message,
          ...
          if (product.description === req.body.description) {
            ...
            product.save();
            message.push(
              "You changed price, brand, amount and description successfully"
            );
            res.render("product/detail", {
              product: product,
              message: message,
      ...
      if (product.brand === req.body.brand) {
        if (product.amount === parseInt(req.body.amount)) {
          ...
          if (product.description === req.body.description) {
            ...
            product.save();
            message.push(
              "You changed name, amount and description successfully"
            );
            res.render("product/detail", {
              product: product,
              message: message,
        ...
        if (product.amount === parseInt(req.body.amount)) {
          if (product.description === req.body.description) {
            ...
            product.save();
            message.push(
              "You changed name, brand and description successfully"
            );
            res.render("product/detail", {
              product: product,
              message: message,
          ...
          if (product.description === req.body.description) {
            ...
            product.save();
            message.push(
              "You changed name, brand, amount and description successfully"
            );
            res.render("product/detail", {
              product: product,
              message: message,
      ...
      if (product.brand === req.body.brand) {
        if (product.amount === parseInt(req.body.amount)) {
          if (product.description === req.body.description) {
            ...
            product.save();
            message.push(
              "You changed name, price and description successfully"
            );
            res.render("product/detail", {
              product: product,
              message: message,
          ...
          if (product.description === req.body.description) {
            ...
            product.save();
            message.push(
              "You changed name, price, amount and description successfully"
            );
            res.render("product/detail", {
              product: product,
              message: message,
        ...
        if (product.amount === parseInt(req.body.amount)) {
          if (product.description === req.body.description) {
            ...
            product.save();
            message.push(
              "You changed name, price, brand and description successfully"
            );
            res.render("product/detail", {
              product: product,
              message: message,
          ...
          if (product.description === req.body.description) {
            ...
            product.save();
            message.push(
              "You changed name, price, brand and amount successfully"
            );
            res.render("product/detail", {
              product: product,
              message: message,
